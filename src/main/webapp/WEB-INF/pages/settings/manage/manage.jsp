    ...
    <form ng-submit="ctrl.submit()" name="tourForm" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7" ng-controller="currencyController as currencyCtrl">
                    <select name="repeatCurrency" id="repeatCurrency" ng-model="ctrl.tour.tourCurrency"
                            id="tourCurrency">
                        <option ng-repeat="currency in currencyCtrl.currency.currencies"
                                ng-selected="ctrl.tour.tourCurrency == currency.currencyId"
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <select ng-model="ctrl.tour.tourActive" id="tourActive">
                        <option ng-repeat="tourActive in ctrl.tourActiveStates"
                                ng-selected="ctrl.tour.tourActive == tourActive.id"
                                value="{{tourActive.id}}">
                            {{tourActive.describe}}
                        </option>
                    </select>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7" ng-controller="guideController as guideCtrl">
                    <select name="repeatSelect" id="repeatSelect" ng-model="ctrl.tour.tourGuide" id="tourGuide">
                        <option ng-repeat="guide in guideCtrl.guide.guides"
                                ng-selected="ctrl.tour.tourGuide == guide.userId" value="{{guide.userId}}">
        ...
        <!--div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7" ng-controller="countryController as countryCtrl">
                    <select ng-model="ctrl.tour.tourCountry" id="tourCountry">
                        <option ng-repeat="country in countryCtrl.country.countries"
                                ng-selected="ctrl.tour.tourCountry == country.id"
                                value="{{country.id}}">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7" ng-controller="cityController as cityCtrl">
                    <select ng-model="ctrl.tour.tourCity" id="tourCity">
                        <option ng-repeat="city in cityCtrl.city.cities"
                                ng-selected="ctrl.tour.tourCity == city.id"
                                value="{{city.id}}">
                            {{city.cityName}}
                        </option>
                    </select>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <select ng-model="ctrl.tour.tourLifeCircle" id="tourLifeCircle">
                        <option ng-repeat="tourLifeCircle in ctrl.tourLifeCircles"
                                ng-selected="ctrl.tour.tourLifeCircle == tourLifeCircle.id"
                                value="{{tourLifeCircle.id}}">
                            {{tourLifeCircle.describe}}
                        </option>
                    </select>
                </div>
            </div>
...
<script src="<%=request.getContextPath()%>/resources/js/controllers/cityService.js"></script>
<script src="<%=request.getContextPath()%>/resources/js/controllers/cityController.js"></script>
<!--script src="<%=request.getContextPath()%>/resources/js/controllers/countryService.js"></script>
<script src="<%=request.getContextPath()%>/resources/js/controllers/countryController.js"></script-->